...
export default class Menu extends Component {
  ...
  openWavesMenu = () => {
    this.setState({ ...this.state, isOpen: true }, () => {
      setTimeout(() => {
        this.state.isOpen && this.setState({ ...this.setState, isReallyOpen: true })
      }, 2000)
    })
  }
  ...
  render() {
    return (
      <div id="menu-general-container">
        <div className={`${this.state.isOpen ? "waves-container-open" : "waves-container-close"} waves-container`} onMouseLeave={() => {
          this.closeWavesMenu();
          this.props.menuLogoToggle("tacubaya")
        }}>

          <div className="wave1 wave" onMouseEnter={() => {
            this.openWavesMenu();
