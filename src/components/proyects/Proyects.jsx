...
export default class Proyects extends Component {
  ...
  render() {
    if (this.props.proyectSelectedId !== 0 && !this.props.proyectSelectedId) {
      return <Redirect to="/" />;
    }
    return (
      <div id="proyectos-general-container">
        <Link to="/" className="logo-bar-proyects">
          <img
            className="sticky-logo-proyect"
            src="./images/Tacubaya_tacubaya_mob.png"
            alt="logo"
          />
        </Link>
        <div className="wave-container wave-container-proyect">
          <img src="./images/Wave_yellow_v01.gif" alt="onda-ama" />
        </div>
        <div className="body-proyect-container">
          <div className="proyect-navigation">
            <div
              className="prev-btn"
              onClick={() => this.props.proyectNavController("prev")}
            >
              <img src="./images/flecha.png" alt="prev-arrow" />
            </div>
            <div
              className="next-btn"
              onClick={() => this.props.proyectNavController("next")}
            >
          ...
          <div className="content-container">
            ...
            <div className="images-container">
              {infoProyects[this.props.proyectSelectedId].images.h1 && (
                <div className="row1">
                  <img
                    src={infoProyects[this.props.proyectSelectedId].images.h1}
                    alt="h1"
                  />
                </div>
              )}
              ...
              {infoProyects[this.props.proyectSelectedId].images.h2 && (
                <div className="row3">
                  <img
                    src={infoProyects[this.props.proyectSelectedId].images.h2}
                    alt="h1"
                  />
                </div>
              )}
              {infoProyects[this.props.proyectSelectedId].images.h3 && (
                <div className="row4">
                  <img
                    src={infoProyects[this.props.proyectSelectedId].images.h3}
                    alt="h1"
                  />
                </div>
              )}
